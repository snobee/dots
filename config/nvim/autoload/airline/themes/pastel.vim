...
call extend(g:airline#themes#pastel#palette.normal, {
...
call extend(g:airline#themes#pastel#palette.insert, {
    \ 'airline_warning':    s:E1,
    \ 'airline_error':      s:E1,
    \ })
let g:airline#themes#pastel#palette.insert_modified = copy(g:airline#themes#pastel#palette.normal_modified)
...
let g:airline#themes#pastel#palette.replace = airline#themes#generate_color_map(s:R1, s:R2, s:R3)
call extend(g:airline#themes#pastel#palette.replace, {
    \ 'airline_warning':    s:E1,
    \ 'airline_error':      s:E1,
    \})
let g:airline#themes#pastel#palette.replace_modified = copy(g:airline#themes#pastel#palette.insert_modified)
...
let g:airline#themes#pastel#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
call extend(g:airline#themes#pastel#palette.visual, {
    \ 'airline_warning':    s:E1,
    \ 'airline_error':      s:E1,
    \})
let g:airline#themes#pastel#palette.visual_modified = copy(g:airline#themes#pastel#palette.insert_modified)

" Inactive window
let s:IA = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi, '']
let g:airline#themes#pastel#palette.inactive = airline#themes#generate_color_map(s:IA, s:IA, s:IA)
...
if get(g:, 'loaded_ctrlp', 0)
    let g:airline#themes#pastel#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
